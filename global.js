...
switch(pg_id){
	...
	break;
	case 2:
	content='<link rel="stylesheet" type="text/css" href="slide2/slide2.css" media="screen"/><div class="s2_1"><img src="slide2/s2_1.png"/></div><div class="s2_2"><img src="slide2/s2_2.png"/></div><div class="s2_3"><img src="slide2/s2_3.png"/></div><div class="s2_4"><img src="slide2/s2_4.png"/></div><div class="s2_5"><img src="slide2/s2_5.png" onclick="pop1()"/></div><div class="s2_6" onclick="pop2()"><img src="slide2/s2_5.png"/></div><div class="s2_7" onclick="pop3()"><img src="slide2/s2_5.png"/></div>';
	break;
	case 3:
	content='<link rel="stylesheet" type="text/css" href="slide3/slide3.css" media="screen"/><div class="s3_1"><img src="slide3/s3_1.png" width="1024" height="768" alt=""></div><div class="s3_2"><img src="slide3/s3_2.png"/></div><div class="s3_3"><img src="slide3/s3_3.png"/></div><div class="s3_4"><img src="slide3/s3_4.png"/></div><div class="s3_5"><img src="slide3/s3_5.png"/></div><div class="graphPop1" onclick="graphPop1()"></div><div class="graphPop2" onclick="graphPop2()"></div>';
	break;
	case 4:
...
function graphPop1() {
	...
	$('.graphPop1').css("display","none");
	$('.graphPop2').css("display","block");
}
